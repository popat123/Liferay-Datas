...
/**
 * Provides the local service interface for Gallery. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Reliance
 * @see GalleryLocalServiceUtil
...
public interface GalleryLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link GalleryLocalServiceUtil} to access the gallery local service. Add custom service methods to {@link com.jio.portlet.gallery.service.impl.GalleryLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
