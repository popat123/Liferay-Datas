...
/**
 * Provides the local service interface for Mentors. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Reliance
 * @see MentorsLocalServiceUtil
...
public interface MentorsLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link MentorsLocalServiceUtil} to access the mentors local service. Add custom service methods to {@link com.jio.portlet.mentors.service.impl.MentorsLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
