...
import com.newsmaker.service.NewsDetailLocalService;

import javax.sql.DataSource;

/**
 * Provides the base implementation for the news detail local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.newsmaker.service.impl.NewsDetailLocalServiceImpl}.
 * </p>
 *
 * @author sandeep.nair
 ...
 * @generated
 */
public abstract class NewsDetailLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements NewsDetailLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.newsmaker.service.NewsDetailLocalServiceUtil} to access the news detail local service.
	 */

	/**
	 * Returns the news detail local service.
	 *
	 * @return the news detail local service
	 */
	public com.newsmaker.service.NewsDetailLocalService getNewsDetailLocalService() {
		return newsDetailLocalService;
	}

	/**
	 * Sets the news detail local service.
	 *
	 * @param newsDetailLocalService the news detail local service
	 */
	public void setNewsDetailLocalService(
		com.newsmaker.service.NewsDetailLocalService newsDetailLocalService) {
		this.newsDetailLocalService = newsDetailLocalService;
	}
	...
	@BeanReference(type = com.newsmaker.service.NewsDetailLocalService.class)
	protected com.newsmaker.service.NewsDetailLocalService newsDetailLocalService;
	...
	private NewsDetailLocalServiceClpInvoker _clpInvoker = new NewsDetailLocalServiceClpInvoker();
}